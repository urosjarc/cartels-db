countries = [
    {'name': 'Taiwan', 'continent': ''},
    {'name': 'Cayman Islands', 'continent': ''},
    {'name': 'Bermuda', 'continent': ''},
    {'name': 'Brasil', 'continent': ''},
    {'name': 'British Virgin Islands', 'continent': ''},
    {'name': 'Ireland', 'continent': 'Europe'},
    {'name': 'China', 'continent': ''},
    {'name': 'UK', 'continent': 'Europe'},
    {'name': 'Hong Kong', 'continent': ''},
    {'name': 'Netherlands', 'continent': 'Europe'},
    {'name': 'Channel Islands', 'continent': ''},
    {'name': 'USA', 'continent': ''},
