...
# db.init_nodes_market_indices(A1012M_type)
...
analysis_core.GC_decision_year_undertaking()
analysis_core.GC_decision_year_holding()
analysis_core.GC_decision_year_minANDmax_case()
analysis_core.GC_columns()
analysis_core.ECJ_decision_year()
analysis_core.ECJ_decision_year_undertaking()
analysis_core.ECJ_decision_year_holding()
analysis_core.ECJ_decision_year_minANDmax_case()
...
analysis_core_anual.Ime_Currency_VAR_Info('InfringeBeginYearFirm', ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info('InfringeBeginYearFirm', year_minus=1, ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info('InfringeBeginYearFirm', year_minus=3, ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info('InfringeBeginYearFirm', year_minus=5, ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('InfringeBeginYearFirm', trend_year=1, ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('InfringeBeginYearFirm', trend_year=3, ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('InfringeBeginYearFirm', trend_year=5, ticker='Ticker_firm')
...
analysis_core_anual.Ime_Currency_VAR_Info('Investigation_begin_year', ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info('Investigation_begin_year', year_minus=1, ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info('Investigation_begin_year', year_minus=3, ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info('Investigation_begin_year', year_minus=5, ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Investigation_begin_year', trend_year=1, ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Investigation_begin_year', trend_year=3, ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Investigation_begin_year', trend_year=5, ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info('Investigation_begin_year', ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('Investigation_begin_year', year_minus=1, ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('Investigation_begin_year', year_minus=3, ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('Investigation_begin_year', year_minus=5, ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Investigation_begin_year', trend_year=1, ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Investigation_begin_year', trend_year=3, ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Investigation_begin_year', trend_year=5, ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('Investigation_begin_year', info='HOLDING', ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('Investigation_begin_year', info='HOLDING', year_minus=1, ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('Investigation_begin_year', info='HOLDING', year_minus=3, ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('Investigation_begin_year', info='HOLDING', year_minus=5, ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Investigation_begin_year', info='HOLDING',  trend_year=1, ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Investigation_begin_year', info='HOLDING',  trend_year=3, ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Investigation_begin_year', info='HOLDING',  trend_year=5, ticker='Ticker_undertaking')

analysis_core_anual.Ime_Currency_VAR_Info('Dawn_raid_year', ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info('Dawn_raid_year', ticker='Ticker_firm', year_minus=1)
analysis_core_anual.Ime_Currency_VAR_Info('Dawn_raid_year', ticker='Ticker_firm', year_minus=3)
analysis_core_anual.Ime_Currency_VAR_Info('Dawn_raid_year', ticker='Ticker_firm', year_minus=5)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Dawn_raid_year', ticker='Ticker_firm', trend_year=1)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Dawn_raid_year', ticker='Ticker_firm', trend_year=3)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Dawn_raid_year', ticker='Ticker_firm', trend_year=5)
analysis_core_anual.Ime_Currency_VAR_Info('Dawn_raid_year', ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('Dawn_raid_year', ticker='Ticker_undertaking', year_minus=1)
analysis_core_anual.Ime_Currency_VAR_Info('Dawn_raid_year', ticker='Ticker_undertaking', year_minus=3)
analysis_core_anual.Ime_Currency_VAR_Info('Dawn_raid_year', ticker='Ticker_undertaking', year_minus=5)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Dawn_raid_year', ticker='Ticker_undertaking', trend_year=1)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Dawn_raid_year', ticker='Ticker_undertaking', trend_year=3)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Dawn_raid_year', ticker='Ticker_undertaking', trend_year=5)
analysis_core_anual.Ime_Currency_VAR_Info('Dawn_raid_year', info='HOLDING', ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('Dawn_raid_year', info='HOLDING', ticker='Ticker_undertaking', year_minus=1)
analysis_core_anual.Ime_Currency_VAR_Info('Dawn_raid_year', info='HOLDING', ticker='Ticker_undertaking', year_minus=3)
analysis_core_anual.Ime_Currency_VAR_Info('Dawn_raid_year', info='HOLDING', ticker='Ticker_undertaking', year_minus=5)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Dawn_raid_year', info='HOLDING', ticker='Ticker_undertaking', trend_year=1)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Dawn_raid_year', info='HOLDING', ticker='Ticker_undertaking', trend_year=3)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('Dawn_raid_year', info='HOLDING', ticker='Ticker_undertaking', trend_year=5)

analysis_core_anual.Ime_Currency_VAR_Info('EC_decision_year',ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info('EC_decision_year',ticker='Ticker_firm', year_minus=1)
analysis_core_anual.Ime_Currency_VAR_Info('EC_decision_year',ticker='Ticker_firm', year_minus=3)
analysis_core_anual.Ime_Currency_VAR_Info('EC_decision_year',ticker='Ticker_firm', year_minus=5)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('EC_decision_year',ticker='Ticker_firm', trend_year=1)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('EC_decision_year',ticker='Ticker_firm', trend_year=3)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('EC_decision_year',ticker='Ticker_firm', trend_year=5)
analysis_core_anual.Ime_Currency_VAR_Info('EC_decision_year',ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('EC_decision_year',ticker='Ticker_undertaking', year_minus=1)
analysis_core_anual.Ime_Currency_VAR_Info('EC_decision_year',ticker='Ticker_undertaking', year_minus=3)
analysis_core_anual.Ime_Currency_VAR_Info('EC_decision_year',ticker='Ticker_undertaking', year_minus=5)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('EC_decision_year',ticker='Ticker_undertaking', trend_year=1)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('EC_decision_year',ticker='Ticker_undertaking', trend_year=3)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('EC_decision_year',ticker='Ticker_undertaking', trend_year=5)
analysis_core_anual.Ime_Currency_VAR_Info('EC_decision_year',info='HOLDING', ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('EC_decision_year',info='HOLDING', ticker='Ticker_undertaking', year_minus=1)
analysis_core_anual.Ime_Currency_VAR_Info('EC_decision_year',info='HOLDING', ticker='Ticker_undertaking', year_minus=3)
analysis_core_anual.Ime_Currency_VAR_Info('EC_decision_year',info='HOLDING', ticker='Ticker_undertaking', year_minus=5)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('EC_decision_year',info='HOLDING', ticker='Ticker_undertaking', trend_year=1)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('EC_decision_year',info='HOLDING', ticker='Ticker_undertaking', trend_year=3)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('EC_decision_year',info='HOLDING', ticker='Ticker_undertaking', trend_year=5)

analysis_core_anual.Ime_Currency_VAR_Info('GC_decision_year', ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info('GC_decision_year', ticker='Ticker_firm', year_minus=1)
analysis_core_anual.Ime_Currency_VAR_Info('GC_decision_year', ticker='Ticker_firm', year_minus=3)
analysis_core_anual.Ime_Currency_VAR_Info('GC_decision_year', ticker='Ticker_firm', year_minus=5)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('GC_decision_year', ticker='Ticker_firm', trend_year=1)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('GC_decision_year', ticker='Ticker_firm', trend_year=3)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('GC_decision_year', ticker='Ticker_firm', trend_year=5)
analysis_core_anual.Ime_Currency_VAR_Info('GC_decision_year', ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('GC_decision_year', ticker='Ticker_undertaking', year_minus=1)
analysis_core_anual.Ime_Currency_VAR_Info('GC_decision_year', ticker='Ticker_undertaking', year_minus=3)
analysis_core_anual.Ime_Currency_VAR_Info('GC_decision_year', ticker='Ticker_undertaking', year_minus=5)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('GC_decision_year', ticker='Ticker_undertaking', trend_year=1)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('GC_decision_year', ticker='Ticker_undertaking', trend_year=3)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('GC_decision_year', ticker='Ticker_undertaking', trend_year=5)
analysis_core_anual.Ime_Currency_VAR_Info('GC_decision_year', info='HOLDING', ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('GC_decision_year', info='HOLDING', ticker='Ticker_undertaking', year_minus=1)
analysis_core_anual.Ime_Currency_VAR_Info('GC_decision_year', info='HOLDING', ticker='Ticker_undertaking', year_minus=3)
analysis_core_anual.Ime_Currency_VAR_Info('GC_decision_year', info='HOLDING', ticker='Ticker_undertaking', year_minus=5)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('GC_decision_year', info='HOLDING', ticker='Ticker_undertaking', trend_year=1)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('GC_decision_year', info='HOLDING', ticker='Ticker_undertaking', trend_year=3)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('GC_decision_year', info='HOLDING', ticker='Ticker_undertaking', trend_year=5)

analysis_core_anual.Ime_Currency_VAR_Info('ECJ_decision_year', ticker='Ticker_firm')
analysis_core_anual.Ime_Currency_VAR_Info('ECJ_decision_year', ticker='Ticker_firm', year_minus=1)
analysis_core_anual.Ime_Currency_VAR_Info('ECJ_decision_year', ticker='Ticker_firm', year_minus=3)
analysis_core_anual.Ime_Currency_VAR_Info('ECJ_decision_year', ticker='Ticker_firm', year_minus=5)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('ECJ_decision_year', ticker='Ticker_firm', trend_year=1)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('ECJ_decision_year', ticker='Ticker_firm', trend_year=3)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('ECJ_decision_year', ticker='Ticker_firm', trend_year=5)
analysis_core_anual.Ime_Currency_VAR_Info('ECJ_decision_year', ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('ECJ_decision_year', ticker='Ticker_undertaking', year_minus=1)
analysis_core_anual.Ime_Currency_VAR_Info('ECJ_decision_year', ticker='Ticker_undertaking', year_minus=3)
analysis_core_anual.Ime_Currency_VAR_Info('ECJ_decision_year', ticker='Ticker_undertaking', year_minus=5)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('ECJ_decision_year', ticker='Ticker_undertaking', trend_year=1)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('ECJ_decision_year', ticker='Ticker_undertaking', trend_year=3)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('ECJ_decision_year', ticker='Ticker_undertaking', trend_year=5)
analysis_core_anual.Ime_Currency_VAR_Info('ECJ_decision_year', info='HOLDING', ticker='Ticker_undertaking')
analysis_core_anual.Ime_Currency_VAR_Info('ECJ_decision_year', info='HOLDING', ticker='Ticker_undertaking', year_minus=1)
analysis_core_anual.Ime_Currency_VAR_Info('ECJ_decision_year', info='HOLDING', ticker='Ticker_undertaking', year_minus=3)
analysis_core_anual.Ime_Currency_VAR_Info('ECJ_decision_year', info='HOLDING', ticker='Ticker_undertaking', year_minus=5)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('ECJ_decision_year', info='HOLDING', ticker='Ticker_undertaking', trend_year=1)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('ECJ_decision_year', info='HOLDING', ticker='Ticker_undertaking', trend_year=3)
analysis_core_anual.Ime_Currency_VAR_Info_YearTrend('ECJ_decision_year', info='HOLDING', ticker='Ticker_undertaking', trend_year=5)
